...
public class ConfirmHeader {
    ...
    public String getRsms() { return Rsms; }

    public ConfirmHeader(String ApiNm, String Tsymd, String Trtm, String Iscd, String FintechApsno, String ApiSvcCd, String IsTuno, String AccessToken){
        this.ApiNm = ApiNm;
        this.Tsymd = Tsymd;
        this.Trtm = Trtm;
        this.Iscd = Iscd;
